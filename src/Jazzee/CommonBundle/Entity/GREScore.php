...
class GREScore
{
    ...
    protected $testCode;
    protected $testName;
    protected $score1Type;
    protected $score1Converted;
    protected $score1Percentile;
    protected $score2Type;
    protected $score2Converted;
    protected $score2Percentile;
    protected $score3Type;
    protected $score3Converted;
    protected $score3Percentile;
    protected $score4Type;
    protected $score4Converted;
    protected $score4Percentile;
    protected $sequenceNumber;
    protected $recordSerialNumber;
    ...
    public function getSummary()
    {
        $arr = array(
            ...
            'Score 1' => $this->score1Type . ' ' .
                $this->score1Converted . ' ' .
                $this->score1Percentile . '%',
            'Score 2' => $this->score2Type . ' ' .
                $this->score2Converted . ' ' .
                $this->score2Percentile . '%',
            'Score 3' => $this->score3Type . ' ' .
                $this->score3Converted . ' ' .
                $this->score3Percentile . '%',
            'Score 4' => $this->score4Type . ' ' .
                $this->score4Converted . ' ' .
                $this->score4Percentile . '%'
        );
