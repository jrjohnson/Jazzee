...
class TOEFLScore
{
    ...
    protected $birthDate;
    protected $gender;
    protected $nativeCountry;
    protected $nativeLanguage;
    protected $testDate;
    protected $testType;
    protected $listeningIndicator;
    protected $speakingIndicator;
    protected $ibtListening;
    protected $ibtWriting;
    protected $ibtSpeaking;
    protected $ibtReading;
    protected $ibtTotal;
    protected $tseScore;
    protected $listening;
    protected $writing;
    ...
    public function setGender($gender)
    {
        if (!in_array(strtolower($gender), array('m', 'f'))) {
            throw new \Exception("{$gender} is not a valid gender");
        }
        $this->gender = $gender;
    }
