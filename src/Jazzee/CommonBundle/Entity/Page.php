...
/**
 * Page
 * A page is not directly associated with an application - it can be a single
 * case or a global page associated with many applications
 *
...
class Page
{
    ...
    protected $answerStatusDisplay;
    protected $instructions;
    protected $leadingText;
    protected $trailingText;
     ...
     */
    private $applicationPageJazzeePage;

    /**
     * a Generic application page we store it so doesn't get recreated
     * @var \Jazzee\CommonBundle\Entity\ApplicationPage
     */
    private $fakeApplicationPage;
    ...
    public function __construct()
    {
        ...
        $this->applicationPages = new ArrayCollection();
        $this->isGlobal = false;
     ...
     * but have no intention of persisting it.
     * Use a string to be sure we cant persist
     */
    ...
    {
        $this->uuid = \Rhumsaa\Uuid\Uuid::uuid4();
        if ($this->parent) {
     ...
     */
    public function addChild(\Jazzee\CommonBundle\Entity\Page $page)
    {
        $this->children[] = $page;
     ...
     * @return \Jazzee\CommonBundle\Entity\Page
     */
     ...
     * @param string $value
     *
     * @return \Jazzee\CommonBundle\Entity\PageVariable
     */
    ...
    /**
     * get page variables
     * @return array \Jazzee\CommonBundle\Entity\PageVariable
     */
     ...
     */
    public function addElement(\Jazzee\CommonBundle\Entity\Element $element)
    {
     ...
     * Get elements
     *
     * @return array \Jazzee\CommonBundle\Entity\Element
     */
    ...
    {
        if ($this->applicationPageJazzeePage == null) {
            $this->applicationPageJazzeePage =
                $this->getFakeApplicationPage()->getJazzeePage();
        }

        return $this->applicationPageJazzeePage;
    }

    /**
     * Create a temporary application page
     * @return \Jazzee\CommonBundle\Entity\ApplicationPage
     */
    public function getFakeApplicationPage()
    {
        if ($this->fakeApplicationPage == null) {
            $this->fakeApplicationPage = new ApplicationPage;
            $this->fakeApplicationPage->setPage($this);
        }

        return $this->fakeApplicationPage;
    }
