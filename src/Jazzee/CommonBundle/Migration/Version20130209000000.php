...
class Version20130209000000 extends \Doctrine\DBAL\Migrations\AbstractMigration
{
    ...
    public function down(\Doctrine\DBAL\Schema\Schema $schema)
    {
        ...
        $table->addColumn('id', 'bigint', array('precision' => 10, 'autoincrement' => true, 'comment'  => ''));
        $table->addColumn('display_id', 'bigint', array('precision' => 10, 'notNull' => false, 'comment' => ''));
        $table->addColumn('attributes', 'array', array('precision' => 10, 'comment'   => ''));
        $table->addColumn(
            'applicationPage_id',
            'bigint',
            array('precision' => 10, 'notNull' => false, 'comment' => '')
        );
        ...
        $table->addColumn('page_id', 'bigint', array('precision' => 10, 'notNull'   => false, 'comment'   => ''));
        ...
        $table = $schema->getTable('displays');
        $table->addColumn('attributes', 'array', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isFirstNameDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isLastNameDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isEmailDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isCreatedAtDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isUpdatedAtDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isLastLoginDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isPercentCompleteDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
        $table->addColumn('isHasPaidDislayed', 'boolean', array('precision' => 10, 'comment'   => ''));
    }
}
