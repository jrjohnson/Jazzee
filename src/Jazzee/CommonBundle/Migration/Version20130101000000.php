...
class Version20130101000000 extends \Doctrine\DBAL\Migrations\AbstractMigration
{
    ...
    public function up(\Doctrine\DBAL\Schema\Schema $schema)
    {
        ...
        $table->addColumn('applicant_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('page_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('parent_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->addColumn('publicStatus_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('privateStatus_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('greScore_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('toeflScore_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('application_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('uniqueId', 'string', array('length'  => 255,'notNull' => false));
        ...
        $table->addColumn('middleName', 'string', array('length'  => 255,'notNull' => false));
        $table->addColumn('lastName', 'string', array('length' => 255));
        $table->addColumn('suffix', 'string', array('length'  => 255,'notNull' => false));
        $table->addColumn('deadlineExtension', 'datetime', array('notNull' => false));
        $table->addColumn('lastLogin', 'datetime', array('notNull' => false));
        $table->addColumn('lastLoginIp', 'string', array('length'  => 15,'notNull' => false));
        $table->addColumn('lastFailedLoginIp', 'string', array('length'  => 15,'notNull' => false));
        ...
        $table->addUniqueIndex(array('application_id','email',	), 'application_email');
        ...
        $table->setPrimaryKey(array('applicant_id','tag_id',	), 'primary');
        $table->addForeignKeyConstraint(
            'applicants',
            array('applicant_id'),
            array('id'),
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('program_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('cycle_id', 'integer', array('precision' => 10,'notNull'   => false));
        $table->addColumn('contactName', 'string', array('length'  => 255,'notNull' => false));
        $table->addColumn('contactEmail', 'string', array('length'  => 255,'notNull' => false));
        ...
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('program_id','cycle_id',	), 'program_cycle');
        $table->addForeignKeyConstraint(
            'programs',
            array('program_id'),
            array('id'),
        ...
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('application_id','page_id',	), 'application_page');
        $table->addUniqueIndex(array('application_id','name',	), 'applicationpage_name');
        $table->addForeignKeyConstraint(
            'applications',
            array('application_id'),
            array('id'),
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('answer_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('applicant_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('user_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('applicant_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->setPrimaryKey(array('cycle_id','page_id',	), 'primary');
        $table->addForeignKeyConstraint(
            'cycles',
            array('cycle_id'),
            array('id'),
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('page_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('element_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('attributes', 'array', array());
        ...
        $table->addColumn('attributes', 'array', array());
        $table->addColumn('applicationPage_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('applicant_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('duplicate_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('applicant_id','duplicate_id',	), 'duplicate_applicant');
        $table->addForeignKeyConstraint(
            'applicants',
            array('applicant_id'),
            array('id'),
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('type_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('page_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('weight', 'integer', array());
        $table->addColumn('fixedId', 'integer', array('notNull' => false));
        $table->addColumn('title', 'string', array('length' => 255));
        $table->addColumn('name', 'string', array('length'  => 255,'notNull' => false));
        $table->addColumn('format', 'string', array('length'  => 255,'notNull' => false));
        ...
        $table->addColumn('instructions', 'text', array('notNull' => false));
        $table->addColumn('defaultValue', 'string', array('length'  => 255,'notNull' => false));
        $table->addIndex(array('type_id'), 'IDX_444A075DC54C8C93');
        $table->addIndex(array('page_id'), 'IDX_444A075DC4663E4');
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('page_id','fixedId',	), 'element_fixedId');
        $table->addUniqueIndex(array('page_id','name',	), 'element_name');
        ...
        $table->addColumn('eShortString', 'string', array('length'  => 255,'notNull' => false));
        ...
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('element_id','name',	), 'item_name');
        $table->addForeignKeyConstraint(
            'elements',
            array('element_id'),
            array('id'),
        ...
        $table->addColumn('departmentCode', 'string', array('length'  => 4,'notNull' => false));
        $table->addColumn('departmentName', 'string', array('length'  => 255,'notNull' => false));
        $table->addColumn('firstName', 'string', array('length' => 255));
        $table->addColumn('middleInitial', 'string', array('length'  => 1,'notNull' => false));
        $table->addColumn('lastName', 'string', array('length' => 255));
        $table->addColumn('birthDate', 'datetime', array());
        $table->addColumn('gender', 'string', array('length'  => 1,'notNull' => false));
        ...
        $table->addColumn('score2Type', 'string', array('length'  => 1,'notNull' => false));
        $table->addColumn('score2Converted', 'integer', array('length'  => 3,'notNull' => false));
        $table->addColumn('score2Percentile', 'decimal', array('length'  => 3,'notNull' => false));
        $table->addColumn('score3Type', 'string', array('length'  => 1,'notNull' => false));
        $table->addColumn('score3Converted', 'integer', array('length'  => 3,'notNull' => false));
        $table->addColumn('score3Percentile', 'decimal', array('length'  => 3,'notNull' => false));
        $table->addColumn('score4Type', 'string', array('length'  => 1,'notNull' => false));
        $table->addColumn('score4Converted', 'integer', array('length'  => 3,'notNull' => false));
        $table->addColumn('score4Percentile', 'decimal', array('length'  => 3,'notNull' => false));
        ...
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('registrationNumber','testMonth','testYear',	), 'gre_registration');

        // Create table: messages
        $table = $schema->createTable('messages');
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('thread_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('page_id','name',	), 'pagevariable_name');
        $table->addForeignKeyConstraint(
            'pages',
            array('page_id'),
            array('id'),
        ...
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('type_id','name',	), 'payment_type_variable_name');
        $table->addForeignKeyConstraint(
            'payment_types',
            array('type_id'),
            array('id'),
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('payment_id', 'bigint', array('precision' => 10,'notNull'   => false));
        $table->addColumn('name', 'string', array('length' => 255));
        $table->addColumn('value', 'text', array());
        $table->addIndex(array('payment_id'), 'IDX_CBE252394C3A3BB');
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('payment_id','name',	), 'payment_variable_name');
        $table->addForeignKeyConstraint(
            'payments',
            array('payment_id'),
            array('id'),
        ...
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('role_id', 'bigint', array('precision' => 10,'notNull'   => false));
        ...
        $table->addColumn('testYear', 'integer', array());
        $table->addColumn('departmentCode', 'string', array('length'  => 4,'notNull' => false));
        $table->addColumn('firstName', 'string', array('length'  => 255,'notNull' => false));
        $table->addColumn('middleName', 'string', array('length'  => 255,'notNull' => false));
        $table->addColumn('lastName', 'string', array('length' => 255));
        $table->addColumn('birthDate', 'datetime', array());
        $table->addColumn('gender', 'string', array('length'  => 1,'notNull' => false));
        ...
        $table->addColumn('listeningIndicator', 'integer', array('length' => 1, 'notNull' => false));
        $table->addColumn('speakingIndicator', 'integer', array('length'  => 1, 'notNull' => false));
        $table->addColumn('IBTListening', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('IBTWriting', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('IBTSpeaking', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('IBTReading', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('IBTTotal', 'integer', array('length'  => 3, 'notNull' => false));
        $table->addColumn('TSEScore', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('listening', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('writing', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('reading', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('essay', 'integer', array('length'  => 2, 'notNull' => false));
        $table->addColumn('total', 'integer', array('length'  => 3, 'notNull' => false));
        $table->addColumn('timesTaken', 'integer', array('length'  => 3, 'notNull' => false));
        $table->addColumn('offTopic', 'string', array('length'  => 1, 'notNull' => false));
        $table->setPrimaryKey(array('id'), 'primary');
        $table->addUniqueIndex(array('registrationNumber', 'testMonth', 'testYear'), 'toefl_registration');

        // Create table: users
        $table = $schema->createTable('users');
        $table->addColumn('id', 'bigint', array('autoincrement' => true));
        $table->addColumn('uniqueName', 'string', array('length' => 255));
        $table->addColumn('email', 'string', array('length'  => 255, 'notNull' => false));
        $table->addColumn('firstName', 'string', array('length'  => 255, 'notNull' => false));
        $table->addColumn('lastName', 'string', array('length'  => 255, 'notNull' => false));
        $table->addColumn('apiKey', 'string', array('length'  => 255, 'notNull' => false));
        $table->addColumn('isActive', 'boolean', array());
        $table->addColumn('preferences', 'array', array('notNull' => false));
        $table->addColumn('defaultProgram_id', 'bigint', array('precision' => 10, 'notNull'   => false));
        $table->addColumn('defaultCycle_id', 'integer', array('precision' => 10, 'notNull'   => false));
        ...
        $table->setPrimaryKey(array('user_id', 'role_id'), 'primary');
        $table->addForeignKeyConstraint(
            'users',
            array('user_id'),
            array('id'),
